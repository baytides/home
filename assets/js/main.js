...
(function () {
  ...
  // Load partials
  async function loadPartial(url, selector, position = 'afterbegin') {
    try {
  ...
  function initAccessibilityPanel() {
    ...
    highContrastToggle.checked = document.documentElement.getAttribute('data-high-contrast') === 'true';
    reducedMotionToggle.checked = document.documentElement.getAttribute('data-reduced-motion') === 'true';
    ...
    document.addEventListener('click', (e) => {
      if (!e.target.closest('.accessibility-panel') && !e.target.closest('.accessibility-toggle')) {
  ...
  function initFormLoading() {
    ...
    // Check for success/error params on page load
  ...
  function initSponsorsCarousel() {
    ...
    function slideTo(newPosition, animate = true) {
    ...
    // Start autoplay if no reduced motion preference
    if (!prefersReducedMotion.matches) {
      startAutoplay();
    }
  }
